...
"background-color: rgb(98, 198, 80);")
        ...
        self.label_5.setPixmap(QtGui.QPixmap("../bg_MainBody.png"))
        ...
        self.lb_NamePaciente = QtWidgets.QLabel(self.groupBox_3)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.lb_NamePaciente.setFont(font)
        self.lb_NamePaciente.setObjectName("lb_NamePaciente")
        self.gridLayout_5.addWidget(self.lb_NamePaciente, 0, 0, 1, 1)
        self.btn_BuscarEjercicios = QtWidgets.QPushButton(self.groupBox_3)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../icons/search.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_BuscarEjercicios.setIcon(icon9)
        self.btn_BuscarEjercicios.setObjectName("btn_BuscarEjercicios")
        self.gridLayout_5.addWidget(self.btn_BuscarEjercicios, 1, 1, 1, 1)
        self.lisWid_WorkOut = QtWidgets.QListWidget(self.groupBox_3)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.lisWid_WorkOut.setFont(font)
        self.lisWid_WorkOut.setObjectName("lisWid_WorkOut")
        self.gridLayout_5.addWidget(self.lisWid_WorkOut, 2, 0, 1, 2)
        self.lineEdit = QtWidgets.QLineEdit(self.groupBox_3)
        self.lineEdit.setObjectName("lineEdit")
        self.gridLayout_5.addWidget(self.lineEdit, 3, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.btn_PlayWorkout, 4, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.btn_StopWorkout, 4, 1, 1, 1)
        self.cb_Paciente = QtWidgets.QComboBox(self.groupBox_3)
        self.cb_Paciente.setObjectName("cb_Paciente")
        self.gridLayout_5.addWidget(self.cb_Paciente, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">NEUROROBOTICS </p><p align=\"center\">S.A de C.V</p></body></html>"))
...
"Terapias"))
        ...
        self.gb_ConectionWithHead.setTitle(_translate("MainWindow", "CONNECTION WITH NEUROBOT"))
...
"de Emociones"))
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "WorkOut List"))
        self.lb_NamePaciente.setText(_translate("MainWindow", "Paciente: "))
        self.btn_BuscarEjercicios.setText(_translate("MainWindow", "Buscar Ejercicios"))
